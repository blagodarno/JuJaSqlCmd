...
public class Main {
    public static void main(String[] argv) throws ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection(
                    "jdbc:postgresql://localhost:5432/article", "postgres",
                    "postgres");

        // insert
        Statement stmt = connection.createStatement();
        stmt.executeUpdate("INSERT INTO public.users (name, surname, login, password, email)" +
                "VALUES ('Stiven', 'Pupkin', st.pup', '123456', 'st_pup@mail.ru')");
        stmt.close();
